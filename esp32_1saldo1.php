    ...
    if (WiFi.status() == WL_CONNECTED) {
      ...
      if (httpCode == 200) {
        ...
        if (!error) {
          ...
          Serial.println("Saldo recebido: " + String(saldo));

          // Lógica: se saldo >= 1, mantém relé ativado
          if (saldo >= 1) {
            ...
            Serial.println("Relé desligado (saldo insuficiente)");
          }
        } else {
